...
public class SysUserRoleController {
    ...
    public CommonResult<List<Long>> getPermissionIds(@PathVariable("userId") Long userId) {
    ...
    @PostMapping("/assign")
    public CommonResult assign(@RequestParam Long userId, @RequestBody List<Long> roleIds) {
