...
public class SysRolePermissionController {
    ...
    public CommonResult<List<Long>> getPermissionIds(@PathVariable("roleId") Long roleId) {
    ...
    @PostMapping("/assign")
    public CommonResult assign(@RequestParam Long roleId, @RequestBody List<Long> permissionIds) {
