...
public class CommonResult<T> implements Serializable{
    ...
    public static <T> CommonResult<T> ok() {
        return new CommonResult<>(CODE_SUCCESS, I18nUtil.getMessage("server.success"), null);
    }
    ...
    public static <T> CommonResult<T> data(T data) {
        return new CommonResult<>(CODE_SUCCESS, I18nUtil.getMessage("server.success"), data);
    }

    // 构建失败
    public static <T> CommonResult<T> error() {
        return new CommonResult<>(CODE_ERROR, I18nUtil.getMessage("server.exception"), null);
    }
